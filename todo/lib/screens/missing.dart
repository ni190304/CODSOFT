...
class _MissingState extends State<Missing> {
  ...
  Stream<QuerySnapshot> getMissingTasksStream(String useremail) {
    DateTime currentDateTime = DateTime.now();

    Stream<QuerySnapshot> missingTasksStream = FirebaseFirestore.instance
        .collection("Tasks") 
        .doc(useremail)
        .collection("`Pending%20Tasks`")
        .where('due', isLessThan: currentDateTime)
        .snapshots();
    ...
    return StreamGroup.merge([missingTasksStream, completedTasksStream]);
  }
        ...
        body: Column(
          ...
          children: [
            ...
            StreamBuilder<QuerySnapshot>(
              stream: getMissingTasksStream(email!),
                        ...
                        return Padding(
                          ...
                          child: Container(
                            decoration: BoxDecoration(
                              color: Color.fromARGB(255, 240, 181, 175),
